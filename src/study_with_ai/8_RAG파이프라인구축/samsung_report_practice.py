...
debug_flag = True
DB_PATH = "../data/practice_samsung_2026"                          # 임베딩 및 저장    
...
# pdf 파일 읽기
def load_pdf_reader():
    reader = PdfReader("../data/16-5_Samsung_Electronics_Sustainability_Report_2026_KOR.pdf")
...
def set_pdf_docs(param_reader):
    ...
    print("pdf_chunks :" +  len(pdf_chunks))

    if(debug_flag):
        print("======================================================")
        print(pdf_chunks[:10])    # 10 페이지 까지 출력        
        print("======================================================")
...
pdf_chunks = set_pdf_docs(reader)                                     # pdf docs 형태의 배열에 담기 
...
# # 1. 사용자로부터 직접 입력받기
# user_input = input("2026 K희망 사다리 관련 정보를 물어봐주세요: ")
